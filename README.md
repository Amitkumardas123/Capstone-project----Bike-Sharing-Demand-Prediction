...
![download](https://github.com/Amitkumardas123/Capstone-project----Bike-Sharing-Demand-Prediction/assets/128244255/05b07453-8b98-49a6-8533-13e95bba9cbe)
...
● Observation 1: In the Model Evaluation Matrices table, Linear Regression, Ridge,Lasso,Elasticnet is not giving great results.
...
● After performing variable importance analysis to find the most significant variables for all the models developed with the given data sets. We are getting the best results from XGBM.
